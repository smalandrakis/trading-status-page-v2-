"""
Train MNQ models v2 - using QQQ data with random train/test split.

Key approach (same as BTC v2):
1. Use QQQ 5-min data (MNQ tracks QQQ closely, ratio ~41.2)
2. Use last 2 years of data (more relevant to current market)
3. Random 75/25 train/test split (not time-based)
4. Train both LONG and SHORT models
5. Focus on shorter horizons (1h, 2h, 4h) for intraday trading
"""
...
# Directories
MODELS_DIR = "models_mnq_v2"
RESULTS_DIR = "results_mnq_v2"

# Horizons (in 5-min bars) - focus on shorter horizons for MNQ intraday
HORIZONS = {
    "30min": 6,
    "1h": 12,
    "1h30m": 18,
...
# Thresholds (percentage move) - MNQ/QQQ has lower volatility than BTC
...
def main():
    print("=" * 80)
    print("MNQ MODEL TRAINING v2 - USING QQQ DATA, RANDOM SPLIT")
    print("=" * 80)
    print(f"Started at: {datetime.now()}")
    
    # Load QQQ data (MNQ tracks QQQ)
    print("\n📂 Loading QQQ data (proxy for MNQ)...")
